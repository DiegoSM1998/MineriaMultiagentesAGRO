...
muestra = muestra[muestra['Producto_TOTAL PATATAS'] == 1]
print(muestra)


muestra.plot(y=["Volumen (miles de kg)","Prediccion_Volumen"], kind='line')
plt.savefig('regression_AMPLImodelpatatas.png')
plt.show()
muestra.plot(y=["Penetración (%)","P_penetración"], kind='line')
plt.savefig('penetraciónPatatas.png')
plt.show()
muestra.plot(y=["Precio medio kg","P_precio"], kind='line')
